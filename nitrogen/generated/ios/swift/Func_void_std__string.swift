...
/**
 * Wraps a Swift `(_ notification: String) -> Void` as a class.
...
public final class Func_void_std__string {
  ...
  private let closure: (_ notification: String) -> Void

  public init(_ closure: @escaping (_ notification: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(notification: std.string) -> Void {
    self.closure(String(notification))
  }
