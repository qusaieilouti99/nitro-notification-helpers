...
namespace margelo::nitro::nitronotificationhelpers::bridge::swift {
  ...
  // pragma MARK: std::shared_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>
  /**
   * Specialized version of `std::shared_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>`.
   */
  using std__shared_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_ = std::shared_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>;
  std::shared_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec> create_std__shared_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_(void* _Nonnull swiftUnsafePointer);
  void* _Nonnull get_std__shared_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_(std__shared_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_ cppType);
  
  // pragma MARK: std::weak_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>
  using std__weak_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_ = std::weak_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>;
  inline std__weak_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_ weakify_std__shared_ptr_margelo__nitro__nitronotificationhelpers__HybridNitroNotificationHelpersSpec_(const std::shared_ptr<margelo::nitro::nitronotificationhelpers::HybridNitroNotificationHelpersSpec>& strong) { return strong; }
